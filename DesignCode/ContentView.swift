...
struct ContentView: View {
    var body: some View {
        ...
        //.cornerRadius(/*@START_MENU_TOKEN@*/30.0/*@END_MENU_TOKEN@*/) USE the code below instead to use the corner smoothing of the native iOS apps or the code above in the background
